...
const User = () => {
  ...
  const handleClick = () => {
    ...
    if (value.name !== "" && value.email !== "" && value.role !== "") {
      ...
      axios({
        url: `${process.env.REACT_APP_BECKEND_URL}/api/users/profile/${id}`,
        method: "PUT",
        headers: {
  ...
  const deleteHandler = (item) => {
    dispatch(setGlobalLoader(true));
    axios({
      url: `${process.env.REACT_APP_BECKEND_URL}/api/users/${item._id}`,
      method: "DELETE",
      headers: {
        authorization: `Bearer ${token}`,
      },
  ...
  useEffect(() => {
    dispatch(setGlobalLoader(true));
    axios({
      url: `${process.env.REACT_APP_BECKEND_URL}/api/users`,
      method: "GET",
      headers: {
        authorization: `Bearer ${token}`,
      },
