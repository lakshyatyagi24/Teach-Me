...
const Faculty = () => {
  ...
  useEffect(() => {
    ...
    axios({
      url: `${process.env.REACT_APP_BECKEND_URL}/api/teachers`,
      method: "GET",
      headers: {
  ...
  useEffect(() => {
    if (!open) {
      dispatch(setGlobalLoader(true));
      axios({
        url: `${process.env.REACT_APP_BECKEND_URL}/api/faculty/admin`,
        method: "GET",
        headers: {
          authorization: `Bearer ${token}`,
        },
  ...
  const deleteHandler = (item) => {
    dispatch(setGlobalLoader(true));
    axios({
      url: `${process.env.REACT_APP_BECKEND_URL}/api/faculty/${item._id}`,
      method: "DELETE",
      headers: {
        authorization: `Bearer ${token}`,
      },
